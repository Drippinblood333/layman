...
.\.venv\Scripts\layman-router status
.\.venv\Scripts\layman-router doctor
.\.venv\Scripts\layman-router codex enable --dry-run
.\.venv\Scripts\layman-router codex enable --apply
.\.venv\Scripts\layman-router report
.\.venv\Scripts\layman-router codex disable --apply
.\.venv\Scripts\layman-router codex backups
```
