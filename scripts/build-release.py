...
def main() -> int:
    ...
    dependency_names = ["fastapi", "httpx", "jsonschema", "pydantic", "PyYAML", "tomlkit", "uvicorn"]
    sbom = {
        "bomFormat": "CycloneDX", "specVersion": "1.5", "version": 1,
        "metadata": {"component": {"type": "application", "name": "layman-codex", "version": VERSION}},
        "components": [
            {"type": "library", "name": name, "version": importlib.metadata.version(name)}
