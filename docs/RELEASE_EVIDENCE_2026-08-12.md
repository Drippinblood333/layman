...
- The current 148-test unit and integration suite passed in the primary Python 3.14.3 environment; the preceding 125-test suite also passed in a clean Python 3.14 environment installed from the hash-locked runtime set before the later bundle-audit and live-benchmark safety regressions were added.
